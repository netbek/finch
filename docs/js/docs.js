...
}).color('species', 'n', { legend: null }), (0, _finch2.default)().vconcat((0, _finch2.default)().width(300).height(300).circle().x('petalLength', 'q', { axis: { title: null } }).y('sepalLength', 'q', { axis: { title: null } }).color('species', 'n', {
  condition: {
    selection: 'hover',
    value: 'black'
  }
...
}).tooltip([{ field: 'sepalLength', type: 'q' }, { field: 'petalLength', type: 'q' }]), (0, _finch2.default)().width(300).tick().x('petalLength', 'q', {
  axis: { labels: false, domain: false, ticks: false }
}).y('species', 'n', {
  axis: { title: null, labels: false, domain: false, ticks: false }
...
var _finch$width$height$b = (0, _finch2.default)('data/iris.csv').width(150).height(150).bar({ binSpacing: 0 }).x('sepalLength', 'q', {
  bin: true
}).y(null, 'q', { aggregate: 'count' }).color(null, 'q', {
  condition: {
    selection: 'hover',
    value: 'black'
  }
...
}).tooltip(null, 'q', { aggregate: 'count' }).column('species', 'n'),
...
}).tooltip([{ field: 'sepalLength', type: 'q' }, { field: 'petalLength', type: 'q' }]),
    spec = _finch$title$width$he.spec;
