...
}).color('species', 'n', { legend: null }), (0, _finch2.default)().vconcat((0, _finch2.default)().width(300).height(300).circle().x('petalLength', 'q', { axis: { title: null } }).y('sepalLength', 'q', { axis: { title: null } }).color('species', 'n', { mouseover: 'black' }).tooltip([{ field: 'sepalLength', type: 'q' }, { field: 'petalLength', type: 'q' }]), (0, _finch2.default)().width(300).tick().x('petalLength', 'q', {
  axis: { labels: false, domain: false, ticks: false }
}).y('species', 'n', {
  axis: { title: null, labels: false, domain: false, ticks: false }
...
var _finch$transform$widt = (0, _finch2.default)('data/iris.csv').transform([{
  bin: true,
  field: 'sepalLength',
  as: 'binSepalLength'
...
var _finch$title$width$he = (0, _finch2.default)('data/iris.csv').title("Edgar Anderson's Iris Data").width(200).height(200).circle().x('petalLength', 'q').y('sepalLength', 'q').color('species', 'n', { mouseover: 'black' }).tooltip([{ field: 'sepalLength', type: 'q' }, { field: 'petalLength', type: 'q' }]),
    spec = _finch$title$width$he.spec;
